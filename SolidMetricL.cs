...
namespace AVC
{
  ...
  SolidMetricL
  {
    ...
    public static readonly string[] BrepErr = {
      ...
      "无法获取实体几何描述 (bRep)。\r\n{0}",
      "No se pudo obtener la descripción de geometría del sólido (bRep).\r\n{0}",
      "Impossible d'obtenir la description de la géométrie du solide (bRep).\r\n{0}",
      "Katı geometri açıklaması (bRep) alınamadı.\r\n{0}"};
    ...
    public static readonly string[] IsNotBanding = {
      ...
      "El material '{0}' será ignorado en el cálculo de canteado. Cambie su propósito en el campo 'Uso'",
      "Le matériau '{0}' sera ignoré dans le calcul du chant. Modifiez son objectif dans le champ 'Utilisation'",
      "Malzeme '{0}' kenar bantlama hesaplamasında yok sayılacaktır. 'Kullanım' alanında amacını değiştirin"};
    ...
    public static readonly string[] IsNotCover = {
      ...
      "El material '{0}' será ignorado en el cálculo de cobertura. Cambie su asignación en el campo 'Uso'",
      "Le matériau '{0}' sera ignoré dans le calcul de la couverture. Modifiez son affectation dans le champ 'Utilisation'",
      "Malzeme '{0}' kaplama hesaplamasında yok sayılacaktır. 'Kullanım' alanında atamasını değiştirin"};
    ...
    public static readonly string[] TooHard = {
      ...
      "Sólido demasiado complejo o error en la API bRep",
      "Solide trop complexe ou plantage dans l'API bRep",
      "Katı çok karmaşık veya bRep API'sinde çökme"};
    ...
    public static readonly string[] ComplexSolid = {
      ...
      "La medición no es posible. El sólido consta de varias partes separadas. \r\n" +
        "Es necesario llamar al comando Separar (_solidedit _body _separate)",
      "La mesure n'est pas possible. Le solide se compose de plusieurs parties distinctes. \r\n" +
        "Il est nécessaire d'appeler la commande Séparer (_solidedit _body _separate)",
      "Ölçüm mümkün değil. Katı birkaç ayrı parçadan oluşur. \r\n" +
    ...
    public static readonly string[] NoFrontForBendingErr = {
      ...
      "El sólido 3D #{0} no tiene un lado frontal plano. No se creará la lista de canteado.",
      "Le solide 3D #{0} n'a pas de côté avant plat. La liste des chants ne sera pas créée.",
      "3D katı #{0} düz bir ön tarafa sahip değil. Kenar bantlama listesi oluşturulmayacak."};
    ...
    public static readonly string[] BendingListErr = {
      ...
      "未能列出 3d 实体 #{0} 的封边条",
      "No se pudo listar los canteados para el sólido 3D #{0}",
      "Impossible de lister les chants pour le solide 3D #{0}",
      "3D katı #{0} için kenar bantları listelenemedi"};
    ...
    public static readonly string[] NoFlatFace = {
      ...
      "身体没有平坦的边缘。",
      "Sólido sin cara plana.",
      "Solide sans face plane.",
      "Düz yüzü olmayan katı."};
    ...
    public static readonly string[] NoPlane = {
      ...
      "No se encontró el plano de referencia para medir el sólido. El sólido fallido se resalta en rojo.",
      "Plan de référence introuvable pour mesurer le solide. Le solide défaillant est surligné en rouge.",
      "Katı ölçümü için referans düzlemi bulunamadı. Başarısız katı kırmızıyla vurgulanır."};
    ...
    public static readonly string[] ZeroMatrix = {
      ...
      "空旋转矩阵。",
      "Matriz de rotación cero.",
      "Matrice de rotation nulle.",
      "Sıfır rotasyon matrisi."};
    ...
    public static readonly string[] NoBottom = {
      ...
      "未找到零件「{0}」的參考平面（位於 XY 平面）\r\n" +
        "零件的形狀太複雜，無法分析。",
      "No se encontró el plano de referencia para la pieza '{0}' (que se encuentra en el plano XY). \r\n" +
        "La forma de la pieza es demasiado compleja para analizar.",
      "Aucun plan de référence n'a été trouvé pour la pièce '{0}' (qui se trouve dans le plan XY). \r\n" +
        "La forme de la pièce est trop complexe pour être analysée.",
      "Parça '{0}' için referans düzlemi bulunamadı (XY düzleminde yer alır). \r\n" +
    ...
    public static readonly string[] ColorErr = {
      ...
      "获取边缘颜色失败。",
      "No se puede obtener el color de la cara.",
      "Impossible d'obtenir la couleur de la face.",
      "Yüzün rengi alınamıyor."};
