...
/* 2 */ CurveL.SaveSources
    ...
    public static readonly string[] HideWhenHoleSelecting = {
      ...
      "Ausblenden beim Auswählen von Subtrahenden",
      "选择减数时隐藏",
      "Ocultar al seleccionar sustraendos",
      "Masquer lors de la sélection des sous-traitants",
      "Çıkarma işlemi yapılırken gizle"};
