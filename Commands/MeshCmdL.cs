...
namespace AVC
{
  ...
  MeshCmdL
  {
    ...
    public static string[] Optimize = {
      "Do you want to optimize solids?",
      "Делать оптимизацию солидов?",
      "Vuoi ottimizzare i solidi?",
      "Möchten Sie Volumenkörpern optimieren?",
      "您想优化三维实体吗？" };
    public static string[] MaxFace = {
      "Enter a limit on the maximum complexity of polygon meshes?",
      "Введите ограничение на максимальную сложность сетей",
      "Enter a limit on the maximum complexity of polygon meshes",
      "Geben Sie eine Grenze für die maximale Komplexität von Polygonnetzen ein",
      "输入多边形网格的最大复杂度限制？" };
  }
}
