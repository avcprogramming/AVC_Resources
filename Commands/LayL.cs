...
/* 2 */ new []{
    ...
    public static readonly string[] MakeTitleTip = {
      ...
      "为每个图形插入文本。",
      "Insertar título para cada pieza.",                        // ES
      "Insérer un titre pour chaque pièce.",                     // FR
      "Her parça için başlık ekle."};                            // TR
    ...
    public static readonly string[] HeightTip = {
      ...
      "Tamaño de texto. Establezca 0 para usar la variable del sistema _TextSize",  // ES
      "Taille du texte. Définissez 0 pour utiliser la variable système _TextSize",  // FR
      "Metin boyutu. Sistem değişkeni _TextSize'ı kullanmak için 0 ayarlayın"};  // TR
    ...
    public static readonly string[] CenterTip = {
      ...
      "生成的文字与图形的中心对齐。",
      "Alinear el centro del título con el centro del detalle.\r\n" +  // ES
        "Si el título está dentro de los detalles, también se realizará una alineación vertical al centro.",
      "Aligner le centre du titre au centre du détail.\r\n" +  // FR
        "Si le titre est à l'intérieur des détails, un alignement vertical au centre sera également effectué.",
      "Başlık merkezini detayın ortasına hizala.\r\n" +  // TR
        "Başlık detayların içindeyse, merkeze dikey hizalama da yapılacaktır."};
    ...
    public static readonly string[] InsideTip = {
      ...
      "将文本放置在图形区域的内部。该程序不计算生成图形的形状。\r\n" +
        ...
        "因为文本置于图形之下。",
      "Para colocar el texto dentro del dibujo de detalle. \r\n" +  // ES
        "El programa no presta atención a los detalles con contornos complejos y\r\n" +
        "coloca el texto dentro del rectángulo condicional restringido con las dimensiones de las piezas.\r\n" +
        "Si activa el modo de renderizado con caras rellenas de sólidos, no verá los encabezados,\r\n" +
        "ya que los textos estarán debajo de los detalles.",
      "Pour placer le texte à l'intérieur du dessin de détail. \r\n" +  // FR
        "Le programme ne fait pas attention aux détails avec des contours complexes et\r\n" +
        "place le texte à l'intérieur du rectangle conditionnel restreint avec les dimensions des pièces.\r\n" +
        "Si vous activez le mode de rendu avec des faces pleines de solides, vous ne verrez pas les en-têtes,\r\n" +
        "car les textes seront sous les détails.",
      "Metni detay çiziminin içine yerleştirmek için. \r\n" +  // TR
        "Program karmaşık konturlu detaylara dikkat etmez ve\r\n" +
        "metni parçaların boyutlarıyla sınırlandırılmış koşullu dikdörtgenin içine yerleştirir.\r\n" +
        "Katıların dolu yüzlü görüntüleme modunu açarsanız, başlıkları göremezsiniz,\r\n" +
        "çünkü metinler detayların altında olacaktır."};
    ...
    public static readonly string[] TitleSpaceTip = {
      ...
      "Relleno adicional entre título y detalle para acomodar dimensiones y directrices. \r\n" +  // ES
        "Establézcalo en 0 para usar una sangría igual a la altura del texto del título.\r\n" +
        "Solo se activa cuando el título se coloca sobre la pieza y no en el centro.\r\n" +
        "En el comando Dibujo de Detalle, esta distancia se traza en el espacio papel, no en el modelo.",
      "Remplissage supplémentaire entre le titre et le détail pour accommoder les dimensions et les lignes de repère. \r\n" +  // FR
        "Réglez sur 0 pour utiliser un retrait égal à la hauteur du texte du titre.\r\n" +
        "Ne se déclenche que lorsque le titre est placé au-dessus de la pièce et non au centre.\r\n" +
        "Dans la commande Dessin de Détail, cette distance est tracée dans l'espace papier, pas dans le modèle.",
      "Boyutları ve işaret çizgilerini barındırmak için başlık ve detay arasında ek dolgu. \r\n" +  // TR
        "Başlık metninin yüksekliğine eşit bir girinti kullanmak için 0 olarak ayarlayın.\r\n" +
        "Yalnızca başlık parçanın üzerine yerleştirildiğinde ve merkezde olmadığında çalışır.\r\n" +
        "Detay Çizim komutunda, bu mesafe modelde değil kağıt alanında çizilir."};
